<?php
/**
 * bbGuild GW2 Extension — extension lifecycle smoke test
 *
...
/**
 * Disables and re-enables bbguildgw2 and asserts the enable/disable HTTP
 ...
 * @group smoke
 */
class avathar_bbguildgw2_smoke_extension_lifecycle_test extends phpbb_functional_test_case
{
	...
	public function test_disable_and_reenable_bbguildgw2()
	{
		$this->assertTrue($this->is_active('avathar/bbguildgw2'), 'bbguildgw2 should already be active from setup_extensions()');

		$this->disable_ext('avathar/bbguildgw2');
		$this->assertFalse($this->is_active('avathar/bbguildgw2'));

		$this->install_ext('avathar/bbguildgw2');
		$this->assertTrue($this->is_active('avathar/bbguildgw2'));
	}
}
